...
class EmaStrategy(IStrategy):
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['rsiema9'] = ta.EMA(dataframe['rsi'], timeperiod=9)
        ...
        # dataframe['min'] = ta.MIN(dataframe['low'], timeperiod=21)
        # dataframe['max'] = ta.MAX(dataframe['high'], timeperiod=21)
        # dataframe['tr'] = ta.ATR(dataframe, timeperiod=21)
        # dataframe['maxv'] = (1 - (dataframe['high'] / dataframe['max'])) * 100
        # dataframe['minv'] = (1 - (dataframe['low'] / dataframe['min'])) * -100
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
                ...
                (dataframe['open'] > dataframe['ema50']) &
